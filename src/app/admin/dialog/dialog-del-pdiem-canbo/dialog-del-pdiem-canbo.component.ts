...
@Component({
  selector: 'app-dialog-del-pdiem-canbo',
  templateUrl: './dialog-del-pdiem-canbo.component.html',
  styleUrls: ['./dialog-del-pdiem-canbo.component.css'],
})
export class DialogDelPdiemCanboComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogDelPdiemCanboComponent>,
  ...
  accept() {
    ...
    PhieudiemComponent.phieudiemCanboService.delete(code, authToken).subscribe(
      () => {
